...
- Quickstart for Mac OS X only
  ...
  - Sign up for the <a href="http://openweathermap.org/">Open Weather Map</a> API so you can enter your API key into the url on line 13 in <code>src/components/Dashboard.jsx</code>
